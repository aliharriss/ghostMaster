...
class TFLiteObjectDetectionAPIModel private constructor() : Classifier {
    ...
    override fun recognizeImage(bitmap: Bitmap): List<Classifier.Recognition> {
        ...
        // TURN THE BITMAP INTO A BYTE BUFFER FOR THE INTERPRETER
        imgData!!.rewind()
        ...
        // CREATE AN EMPTY OUTPUT MAP WITH THE CORRECT DIMENSIONS
        ...
        for (i in 0 until NUM_DETECTIONS) {
            val detection = RectF(
                    // BOUNDING BOX OUTPUT FOR EACH DETECTED OBJECT
